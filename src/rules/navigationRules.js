...
export const navigationRules = [
  ...
  { rule_id             : 'NAVIGATION_1',
    ...
    validate            : function (dom_cache, rule_result) {
      ...
      debug.log(`[NAVIGATION 1]: ${dom_cache} ${rule_result}`);
...
*/
  ...
  { rule_id             : 'NAVIGATION_2',
    ...
    validate            : function (dom_cache, rule_result) {
      ...
      debug.log(`[NAVIGATION 2]: ${dom_cache} ${rule_result}  ${TEST_RESULT}`);
...
/*
  ...
  { rule_id             : 'NAVIGATION_3',
    ...
    validate            : function (dom_cache, rule_result) {
      ...
      debug.log(`[NAVIGATION 3]: ${dom_cache} ${rule_result}`);
...
*/
  ...
  { rule_id             : 'NAVIGATION_4',
    ...
    validate            : function (dom_cache, rule_result) {
      ...
      debug.log(`[NAVIGATION 4]: ${dom_cache} ${rule_result}`);
...
*/
  ...
  { rule_id             : 'NAVIGATION_5',
    ...
    validate            : function (dom_cache, rule_result) {
      ...
      debug.log(`[NAVIGATION 5]: ${dom_cache} ${rule_result}`);
